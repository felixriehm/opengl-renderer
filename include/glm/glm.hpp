...
/// With OpenGLWrapper's GLSL, these qualifiers have no effect; they are there for compatibility,
/// with OpenGLWrapper ES's GLSL, these qualifiers do have an effect.
///
...
///
/// @mainpage OpenGLWrapper Mathematics (GLM)
