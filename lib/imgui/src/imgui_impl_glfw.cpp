...
// (Info: GLFW is a cross-platform general purpose library for handling windows, inputs, OpenGLWrapper/Vulkan graphics context creation, etc.)
// (Requires: GLFW 3.1+)
...
//  2018-06-08: Misc: Extracted imgui_impl_glfw.cpp/.h away from the old combined GLFW+OpenGLWrapper/Vulkan examples.
